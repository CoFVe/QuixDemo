...
$app.goToUrl = function(element) {
    $.mobile.changePage($(element).attr('data-url'), { transition: $(element).attr('data-transition') });
    
};

$app.catchEnter = function(object) {
        if (event.keyCode === 13) {
